...
#Para las variables categoricas se utiliza prueba de chi cuadrado
#No entiendo muy bien este analisis
chisq.test(data2$anaemia,data$DEATH_EVENT)
chisq.test(data2$smoking,data$DEATH_EVENT)
chisq.test(data2$sex,data$DEATH_EVENT)
chisq.test(data2$high_blood_pressure,data$DEATH_EVENT)
chisq.test(data2$diabetes,data$DEATH_EVENT)
